...
[
  ...
  //QUESTIONS BASED ON THE ABOVE OBJECTS 

  //Q1. print all the titles 
  console.log("============ all the title ================");
  let alltitle= movies.map((title)=>{
    console.table(title.Title);
  })

  console.log("============ all the movie title ================");
  //Q2. print all the movie title
  let movieTitle= movies.filter((title)=>{
...
movieTitle.map((data)=>{
  ...
  //Q3. print the movie directed by james cameron 
  console.log("===========movie directed by james cameron  =================");
  let res = movies.filter((data)=>{
    return data.Director=="James Cameron" ;

  })
  console.log(res);

  //Q4. print the movie released after 2012
  console.log("=================== movie released after 2012 =========================");
  let res2 = movies.filter((data)=>{
    return data.Year>2012;
  })
console.log(res2);
  //Q5. print the movie whihc has highest IMDB rating
  console.log("===================  highest IMDB rating ============================");
  let res3 = movies.map((data)=>{
    return data.imdbRating;
  })
  let imbd = res3.filter((data)=>{
    return data !=='N/A';
  })
  console.log(Math.max(...imbd)); //here ...imbd is called as spread Operator 
