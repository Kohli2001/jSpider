...
public class VerifyMerchantByIdPassword {

	public static void main(String[] args) {
		Scanner sc = new Scanner(System.in);
		System.out.println("Enter the Id and Passowrd to Verify the Merchant");
		int id =sc.nextInt();
		String password=sc.next();
		
		EntityManager manager= Persistence.createEntityManagerFactory("dev").createEntityManager();
		String jpql ="select m from Merchant m where m.id=?1 and m.password=?2";
